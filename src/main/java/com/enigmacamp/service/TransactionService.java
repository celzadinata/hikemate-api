...
public interface TransactionService {
    ...
    Page<TransactionResponse> getAll(Boolean isUp, Boolean isDown, String status, String rangerId, String hikerId, String mountainId, String hikerName, SearchRequest searchRequest);
